...
import { toast } from 'react-toastify'; // Importing toast if you are using react-toastify
...
const BMICalculator = () => {
  ...
  const calculateBMI = (e) => {
    ...
    if (!height || !weight || !gender || gender === "select gender") {
    ...
    if (bmivalue < 18.5) {
      ...
      toast.error("You are in the obese range. It is recommended to seek advice from a healthcare expert.");
    }
  };
